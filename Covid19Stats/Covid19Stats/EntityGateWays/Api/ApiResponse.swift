...
// Optionally, if you use JSON you can implement InitializableWithJsonArray protocol
protocol InitializableWithJsonArray {
...
extension NSError {
    static func createPraseError() -> NSError {
        return NSError(domain: "com.covid19api",
